...
\newcommand{\system}[1]{\overset{#1}{\longleftrightarrow}}
\usepackage{graphicx}
\usepackage{textcomp}
\usepackage{xcolor}
\usepackage{txfonts}
...
\title{Audio Filter}
\author{EE23BTECH11047 - P Deepak Reddy
}
\maketitle
\newpage
...
\begin{lstlisting}
https://github.com/Deepakreddy1510/Audio_filter/blob/main/codes/audiofiltering.wav
\end{lstlisting}
...
\\
%
\solution There are a lot of yellow lines between 440 Hz to 1 KHz.  These represent the synthesizer key tones. Also, the key strokes
are audible along with background noise.\\
% By observing spectrogram, it clearly shows that tonal frequency is under 4kHz. And above 4kHz only noise is present.
\begin{figure}[ht]
   \centering
   \includegraphics[width=1.1\columnwidth]{figs/original.png}
   \caption{Spectrogram of original audio}
\end{figure}
\\
\item
\label{prob:output}
...
\item
The output of the python script in Problem \ref{prob:output} is the audio file Sound\_With\_audiofiltering.wav. Play the file in the spectrogram in Problem \ref{prob:spectrogram}. What do you observe?
\\
...
\begin{figure}[ht]
   \centering
   \includegraphics[width=1.0\columnwidth]{figs/reduced_noise.png}
...
\begin{lstlisting}
https://github.com/Deepakreddy1510/Audio_filter/blob/main/codes/3.2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/Deepakreddy1510/Audio_filter/blob/main/codes/3.2.py
\end{lstlisting}
\newpage
\begin{figure}[htbp]
	\centering
...
\begin{lstlisting}
https://github.com/Deepakreddy1510/Audio_filter/blob/main/codes/4.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Deepakreddy1510/Audio_filter/blob/main/codes/5.2.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\begin{lstlisting}
https://github.com/Deepakreddy1510/Audio_filter/blob/main/codes/5.4.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
%
\begin{lstlisting}
https://github.com/Deepakreddy1510/Audio_filter/blob/main/codes/5.5.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\begin{lstlisting}
https://github.com/Deepakreddy1510/Audio_filter/blob/main/codes/6_sol.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Deepakreddy1510/Audio_filter/blob/main/codes/6.4.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Deepakreddy1510/Audio_filter/blob/main/codes/6.5.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\begin{lstlisting}
https://github.com/Deepakreddy1510/Audio_filter/blob/main/codes/7.1.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\solution The code in audio filter problem generates the values of $a$ and $b$  which can be used to generate a difference equation.\\
And,
\begin{align}
    M &= 5\\
    N&=5
...
\begin{lstlisting}
https://github.com/Deepakreddy1510/Audio_filter/blob/main/codes/7.2.py
\end{lstlisting}

\input{tables/audio_table1}
...
\begin{lstlisting}
https://github.com/Deepakreddy1510/Audio_filter/blob/main/codes/7_filter_response.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\solution The Sampling Frequency is 43.1KHz\bigskip
\item
